...
<div className="glass-card-solid p-4 sm:p-6 space-y-4 mt-4"><p className="text-sm text-gray-500">Auto-blacklist settings have been moved to the <a href="/dashboard/auto-blacklist" className="text-brand-500 font-bold hover:underline">Automatic Blacklist</a> page.</p></div></>}
