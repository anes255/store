...
const PRESETS=[
  ...
  {name:'EcoTrack',logo:'E',color:'from-teal-500 to-green-500',api_base_url:'https://app.ecotrack.dz/api/v1',api_auth_type:'bearer',api_tracking_endpoint:'/get/order/label?tracking={tracking_number}',api_status_path:'data.0.activity.0.event',headers:[],query_params:[],help:'ecotrack.dz → Dashboard → API → copy your Bearer token (single token)',verified:true,
    create_endpoint:'/create/order',create_method:'POST',create_tracking_path:'tracking',
  ...
  {name:'DHD Livraison',logo:'D',color:'from-sky-500 to-blue-600',
    ...
    api_tracking_endpoint:'/get/order/label?tracking={tracking_number}',
    api_status_path:'data.0.activity.0.event',
