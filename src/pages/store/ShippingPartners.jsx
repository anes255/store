...
const PRESETS=[
  ...
  {name:'NOEST Express',logo:'N',color:'from-green-500 to-emerald-500',api_base_url:'https://app.noest-dz.com',api_auth_type:'bearer',api_tracking_endpoint:'/get/tracking/info?tracking={tracking_number}',api_status_path:'data.activity.0.event',headers:[],query_params:[],help:'NOEST partner portal (app.noest-dz.com) → API → copy your Bearer token.',verified:true,
