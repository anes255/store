...
const PRESETS=[
  ...
  {name:'NOEST Express',logo:'N',color:'from-green-500 to-emerald-500',api_base_url:'https://app.noest-dz.com',api_auth_type:'bearer',api_tracking_endpoint:'/api/public/get/trackings/info',api_status_path:'activity.0.event',headers:[],query_params:['user_guid','default_station_code'],help:'NOEST partner portal (app.noest-dz.com) → API → copy your Bearer api_token into "API Key" field, paste your user_guid below, and (for desk delivery) paste your station code from NOEST dashboard → Stations into "default_station_code". Without this field, all desk orders will be rejected.',verified:true,method:'POST',body_template:'{"trackings":["{tracking_number}"]}',
    create_endpoint:'/api/public/create/order',create_method:'POST',create_tracking_path:'tracking',
  ...
  {name:'DHD Livraison',logo:'D',color:'from-sky-500 to-blue-600',
    ...
    headers:[],query_params:['default_station_code'],
    help:'DHD partner portal (dhd.ecotrack.dz) → API → copy your Bearer token into "API Key", and (for desk delivery) paste your station code from DHD dashboard → Stations / Bureaux into "default_station_code". Without it, desk orders silently appear as "domicile" on the carrier site.',
    verified:true,
