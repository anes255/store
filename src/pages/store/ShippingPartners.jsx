...
const PRESETS=[
  ...
  {name:'NOEST Express',logo:'N',color:'from-green-500 to-emerald-500',api_base_url:'https://app.noest-dz.com',api_auth_type:'bearer',api_tracking_endpoint:'/api/public/get/trackings/info',api_status_path:'activity.0.event',headers:[],query_params:['user_guid'],help:'NOEST partner portal (app.noest-dz.com) → API → copy your Bearer api_token into "API Key" field, and paste your user_guid below.',verified:true,method:'POST',body_template:'{"trackings":["{tracking_number}"]}',
