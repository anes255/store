...
export default function ProductDetail() {
  ...
  return (
    <div className={`min-h-screen w-full max-w-full overflow-x-hidden ${buyerTheme.mode==='dark'?'buyer-theme-dark bg-[#0b1020] text-gray-100':'bg-[#f5f5f5] text-gray-900'}`} style={store?.config?.store_bg_color&&buyerTheme.mode!=='dark'?{background:store.config.store_bg_color}:undefined}>
