...
const DEFAULT_ITEMS = [
  ...
  {id:'delivery',type:'group',icon:'Truck',label:'sidebar.delivery',children:[
    {to:'/dashboard/shipping-partners',label:'sidebar.shippingPartners'},{to:'/dashboard/shipping-wilayas',label:'sidebar.shippingWilayas'},{to:'/dashboard/how-to-connect',label:'sidebar.howToConnect'},{to:'/dashboard/order-tracking',label:'sidebar.orderTrackingSettings'},{to:'/dashboard/status-management',label:'sidebar.statusManagement'},{to:'/dashboard/tracking-orders',label:'sidebar.trackingOrders'}]},
