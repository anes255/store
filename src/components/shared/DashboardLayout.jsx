...
const DEFAULT_ITEMS = [
  ...
  {id:'store',type:'group',icon:'Globe',label:'Store & Settings',children:[
    {to:'/dashboard/settings',label:'All Settings'},{to:'/dashboard/page-builder',label:'Page Builder'},{to:'/dashboard/homepage',label:'Home Page'},{to:'/dashboard/contact',label:'Contact Info'},{to:'/dashboard/faqs',label:'FAQs'},{to:'/dashboard/about',label:'About Us'},{to:'/dashboard/order-tracking',label:'Order Tracking'},{to:'/dashboard/domains',label:'Domains'}]},
